...
app.http("OrderFormParserService", {
  ...
  handler: async (request, context) => {
    ...
    try {
      ...
      orderResponse.billingAddress.firstName = orderRequest?.billing.first_name;
      ...
      orderResponse.shippingAddress.lastName = orderRequest?.shipping.last_name;
      orderResponse.shippingAddress.phone = orderRequest?.shipping.phone;
      orderResponse.shippingAddress.address1 = orderRequest?.shipping.address_1;
      orderResponse.shippingAddress.address2 = orderRequest?.shipping.address_2;
